...
?>
    <div class="alert alert-info" role="alert">Только заказ со статусом
        <strong>"<?= Order::getStatusName(Order::STATUS_CANCELED); ?>"</strong> или
        <strong>"<?= Order::getStatusName(Order::STATUS_ARCHIVE); ?>"</strong> можно удалить.
    </div>
<?= GridView::widget([
